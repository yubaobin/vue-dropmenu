...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign__ = __webpack_require__(36);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    this.changeColor = [].concat(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_toConsumableArray___default()(this.colors));
  ...
  watch: {
    activeObj: function activeObj(newValue, oldValue) {
      var index = this.list.findIndex(function (elem) {
        return elem.name === newValue.name;
      });
      this.changeColor = [].concat(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_toConsumableArray___default()(this.colors));
    ...
    show: function show(newValue) {
      if (newValue) {
        var elmOffset = this.elm.getBoundingClientRect();
        var winW = document.documentElement.clientWidth;
        var winH = document.documentElement.clientHeight;
        var parent = this.elm.parentNode;
        var parentW = parent.offsetWidth;
        var parentH = parent.offsetHeight;
        var elmX = elmOffset.x | elmOffset.left;
        var elmY = elmOffset.y | elmOffset.top;
        var elmLeft = this.elm.offsetLeft;
        var elmTop = this.elm.offsetTop;
        var elmW = this.elm.clientWidth;
        var elmH = this.elm.clientHeight;
        ...
        this.cssStyle = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()(horizontal, vertical, normalCss);
      }
    }
  },
  ...
  methods: {
    handleClick: function handleClick(e, obj) {
      this.activeObj = obj;
    ...
    getMaxLength: function getMaxLength(list) {
      var m = 0;
...
var components = [__WEBPACK_IMPORTED_MODULE_0__menu_vue___default.a];
...
var ctx            = __webpack_require__(19)
  ...
  , getIterFn      = __webpack_require__(29);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('transition', {
    ...
    staticClass: "arrow",
    style: ({
      'border-color': (_vm.bgColor + " " + _vm.bgColor + " transparent transparent")
    })
...
var update = __webpack_require__(75)("37275ce0", content, false);
